...
//Array to store the city search history
var cityHist = [];
//Saves the text value of the search to the array and localstorage
...
//Creates the buttons based on the searches
...
//Applies the weather data to the today card and shows five day forecast
...
function getFiveDayForecast() {
	...
	$.ajax({
		...
		for (let i = 0; i < myWeather.length; i++) {
            ...
            //Wind Speed
            var pElWind = $('<p>').text(`Wind Speed: ${myWeather[i].windspeed} mph`);
		}
	});
};

//Allows for the example data to load for Cleveland
function initLoad() {
